...
// Các topic MQTT
const topics = {
    fanStatus: 'Lab001/fan/status',     // Topic nhận trạng thái quạt từ ESP32
    ledStatus: 'Lab001/led/status',     // Đã sửa thành A4002/led/status để phù hợp
    fanControl: 'Lab001/fan/control',   // Topic gửi lệnh điều khiển quạt tới ESP32
    ledControl: 'Lab001/led/control',   // Topic gửi lệnh điều khiển đèn tới ESP32
    ...
    //thêm topic gửi chế độ điểu khiển tới ESP32
    modeControl: 'Lab001/mode/control' // Topic gửi lệnh điều khiển chế độ tới ESP32
};
...
function toggleMode(mode) {
    ...
    if (mqttClient && mqttClient.isConnected()) {
        ...
        modeMessage.destinationName = 'Lab001/mode/control';
        modeMessage.qos = 1;
